...
<div class="container-fluid" style="padding-top: 80px;">
    ...
    <form method='GET' action='./detail.php' class="form-inline">
        <div class="row">
    ...
    <div class="row toggle" id='commonpatterns'>
        <div class="col-lg-12">
            <ul class="nav nav-pills" role="tablist" style="width: 100%;">
                <li role="presentation" class="active" style="width: 100%;"><a href="#" style="font-weight: 800">Common
                        Patterns (Matching our Regex)</a></li>
            </ul>
        </div>
    </div>

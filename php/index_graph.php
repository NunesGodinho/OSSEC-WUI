...
if ($glb_indexgraphkey == 1) {
    ...
    $( document ).ready(function() {
        $('#chartdiv').css({ 'height': '" . (500 + ($graphcount * $graphheightmultiplier)) . "px' });
    });";
}
...
for ($i = $daysago; $i >= 0; $i--) {
    ...
    if (date('N', strtotime('-' . $i . ' days')) == 6 || date('N', strtotime('-' . $i . ' days')) == 7) {
		...
		{
		    id : 'guide . $i .',
		    date : new Date(2012, " . $guidemonth . ", " . $guidedate . ", 0, 0),
		    toDate : new Date(2012, " . $guidemonth . ", " . $guidedate . ", 23, 59),
		...
		{
		    id : 'guide" . $i . "am',
		    date : new Date(2012, " . $guidemonth . ", " . $guidedate . ", 0, 1),
		    toDate : new Date(2012, " . $guidemonth . ", " . $guidedate . ", " . $glb_outofhours_daystart . ", 0),
		    fillColor : '" . $glb_outofhourscolour . "',
		    inside : false,
		    fillAlpha : 0.2,
		    lineAlpha : 0
		...
		{
		    id : 'guide" . $i . "pm',
		    date : new Date(2012, " . $guidemonth . ", " . $guidedate . ", " . $glb_outofhours_dayend . ", 0),
		    toDate : new Date(2012, " . $guidemonth . ", " . $guidedate . ", 23, 59),
		    fillColor : '" . $glb_outofhourscolour . "',
		    inside : false,
		    fillAlpha : 0.2,

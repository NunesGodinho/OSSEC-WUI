...
<div>
    <ul class="list-group">
        <li class="list-group-item d-flex justify-content-between align-items-center active">
            Top Rule_ID
            <span class="badge badge-secondary badge-pill">(<?php echo $inputhours . " Hrs (lvl " . ($inputlevel); ?>)</span>
        </li>
    </ul>
</div>
<?php
...
if (!$stmt->rowCount()) {
    ...
    $mainstring .= "<table class=\"table table-hover table-striped table-sm\"><tbody>";
